...
regHandle
  ...
  .on(RegActions.validate, state => {
    if (isUndefined(state.validName)) state.validName = false;
    if (isUndefined(state.validEmail)) state.validEmail = false;
    if (isUndefined(state.validPhone)) state.validPhone = false;
    if (isUndefined(state.validPassword)) state.validPassword = false;
  });
